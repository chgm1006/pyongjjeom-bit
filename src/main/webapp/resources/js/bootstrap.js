...
/*
 * ========================================================= bootstrap-modal.js
 * v2.2.2 http://twitter.github.com/bootstrap/javascript.html#modals
 * ========================================================= Copyright 2012
 * Twitter, Inc.
 * 
	...
	Modal.prototype = {
		...
		backdrop : function(callback) {
			...
			if (this.isShown && this.options.backdrop) {
				...
				this.$backdrop.click(this.options.backdrop == 'static' ? $.proxy(
						this.$element[0].focus, this.$element[0]) : $
				...
				$.support.transition && this.$element.hasClass('fade') ? this.$backdrop
						.one($.support.transition.end, $.proxy(this.removeBackdrop, this))
						: this.removeBackdrop()
...
!function($) {
	...
	$(document).on('click.dropdown.data-api touchstart.dropdown.data-api',
			clearMenus).on('click.dropdown touchstart.dropdown.data-api',
...
!function($) {
	...
	function ScrollSpy(element, options) {
		var process = $.proxy(this.process, this), $element = $(element).is('body') ? $(window)
				: $(element), href
	...
	ScrollSpy.prototype = {
					...
					.map(
							function() {
								var $el = $(this), href = $el.data('target')
										|| $el.attr('href'), $href = /^#\w/.test(href) && $(href)
		...
		,
		process : function() {
			var scrollTop = this.$scrollElement.scrollTop() + this.options.offset, scrollHeight = this.$scrollElement[0].scrollHeight
...
/*
 * ======================================================== bootstrap-tab.js
 * v2.2.2 http://twitter.github.com/bootstrap/javascript.html#tabs
 * ======================================================== Copyright 2012
 * Twitter, Inc.
 * 
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
...
!function($) {
	...
	Tab.prototype = {
		...
		,
		show : function() {
			var $this = this.element, $ul = $this.closest('ul:not(.dropdown-menu)'), selector = $this
...
!function($) {
	...
	Tooltip.prototype = {
		...
		getOptions : function(options) {
			options = $.extend({}, $.fn[this.type].defaults, options, this.$element
					.data())
...
/*
 * ========================================================== bootstrap-affix.js
 * v2.2.2 http://twitter.github.com/bootstrap/javascript.html#affix
 * ========================================================== Copyright 2012
 * Twitter, Inc.
 * 
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
...
/*
 * ========================================================== bootstrap-alert.js
 * v2.2.2 http://twitter.github.com/bootstrap/javascript.html#alerts
 * ========================================================== Copyright 2012
 * Twitter, Inc.
 * 
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
		...
		return this
				.each(function() {
					var $this = $(this), data = $this.data('carousel'), options = $
							.extend({}, $.fn.carousel.defaults, typeof option == 'object'
									&& option), action = typeof option == 'string' ? option
							: options.slide
					if (!data)
...
!function($) {
	...
	Typeahead.prototype = {
		...
		lookup : function(event) {
			...
			items = $.isFunction(this.source) ? this.source(this.query, $.proxy(
					this.process, this)) : this.source
		...
		highlighter : function(item) {
			...
			return item.replace(new RegExp('(' + query + ')', 'ig'), function($1,
					match) {
