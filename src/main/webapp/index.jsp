...
<!-- ########################################### -->
		...
		<div class="topMenu">
			...
			<div class="rightMenu">
				<ul>
					...
					<li class="menu7"><a href="board.html" class="menu7_1">공지사항</a></li>
				</ul>
			</div>
		</div>
	</header>
	...
	<article>
		...
		<div class="contentsList">
			...
			<!------------------- 리스트 첫번째 -------------------->
			<div class="list1">
				<a href="#" class="listImgLink"><img src="${pageContext.request.contextPath}/resources/img/06.jpg"
					class="listImg"></a>
				<div class="detail">
					<table>
						<tr>
						...
						<tr>
							...
							<td class="listSynopValue">가까운 미래, 미믹이라 불리는 외계 종족의 침략으로 인류는
								멸망 위기를 맞는다. 빌 케이지 (톰 크루즈)는 자살 작전이나 다름없는 작전에 훈련이나 장비를 제대로 갖추지 못한
								상태로 배정되고 전투에 참여하자마자 죽음을 맞는다. 하지만 불가능한 일이 일어난다. 그가 다시 그 끔찍한 날이
								시작된 시간에 다시 깨어나 다시 전투에 참여하게 되고 다시 죽었다가 또 다시 살아나는 것. 외계인과의 접촉으로 같은
								시간대를 반복해서 겪게 되는 타임 루프에 갇히게 된 것이다.</td>
						</tr>
					</table>
...
<!---- above page 시작 ---->	
	<div id='overLayer'>
		...
		<!---- 큰 포스터 JPG ---->	
		<div class="overTitle">
			<a href="#" class="exit"></a> <img src="${pageContext.request.contextPath}/resources/img/06.jpg">
		</div>
		
		<!---- 작은 포스터 JPG + 평균평점 ---->
		<div class="overCont">
			<div class="overContDetail">
				<img src="${pageContext.request.contextPath}/resources/img/06.jpg" class="overContDetailImg">
			...
			<div class="overContSpec">
				...
				<div class="overContSpecSynop">
					<h3>줄거리</h3>
					<br>
					<h4>2년의 세월이 흘렀다. 갑자기 떠난 시즈루(미야자키 아오이). 2년 후 그녀에게서 온 편지를 들고
						마코토(타마키 히로시)는 크리스마스로 들뜬 뉴욕으로 왔다. 그러나 그를 보러 온 건 미유키(쿠로키 메이사)였다. 과연
						그녀에겐 무슨 일이 있는 것일까? 6년 전, 대학 입학식 날. 번잡한 횡단보도를 건너려는 시즈루와 마주친 마코토.
						"여기선 건널 수 없으니까 저쪽에서 건너는 게 좋을 거야" 마코토는 조금은 별난 행동을 하는 그녀를 향해 셔터를
						누른다. 둘 만의 숲. 늘 약 냄새가 난다고 생각하는 마코토, 냄새를 잘 못 맡는 시즈루. 둘은 친구가 되고, 매일
						캠퍼스 뒷 숲에서 사진을 찍는다. 그러나 시즈루를 여자로 보지 않는 마코토는 퀸카 미유키를 짝사랑하고 있다. 시즈루는
						성숙한 여자가 되기로 결심하는데...</h4>
				</div>
				...
				<div class="overContSpecComment">
					...
					<div class="commentBox">
						<div class="userPhoto">
							<a href="#" class="userRoom"><img src="${pageContext.request.contextPath}/resources/img/user1.jpg"></a><br>박희본
						</div>
