		...
		<div class="row">
			...
			<div class="register span6">
				<form id="register" name="register" action="upDateMySet.do" method="post">
					...
					<input type="hidden" name="memCD" value="${member.memCD}"> <input
						type="hidden" name="email" value="${member.email}"> <label
						for="email">이메일</label> <input type="text" id="email"
						value="${member.email}" disabled> <label for="name">이름</label> <input
						type="text" id="name" name="memNm" value="${member.memNm}"> <label
