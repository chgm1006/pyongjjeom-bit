...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		$('.register form').submit(function() {
			...
			if (!checkEmail(email)) {
				$(this).find("label[for='email']").append("<span style='display:none' class='red'> - 이메일 형식에 맞지 않습니다.</span>");
				$(this).find("label[for='email'] span").fadeIn('medium');
    ...
    <div class="row" style="width: 600px; margin: 0 auto;">
      ...
      <div class="register span6">
        <form action="emailAuth_sendCD.do" method="post">
          ...
          <label for="email">Email</label> <input type="text" id="email" name="email" placeholder="이메일을 입력하세요...">
