  ...
  <div class="register-container container">
    <div class="row" style="width: 600px; margin: 0 auto;">
      ...
      <div class="register span6">
        <form action="changePasswd.do" method="post">
          <h3>
            <span class="red"><strong>비밀번호 변경</strong></span>
          </h3>
          <label for="passwd">새 비밀번호 &nbsp; &nbsp;</label> <input type="password" id="passwd" name="passwd"
            placeholder="비밀번호"><br> <label for="passwdCheck">새 비밀번호 확인 &nbsp; &nbsp;</label> <input
            type="password" id="passwdCheck" name="passwdCheck" placeholder="비밀번호 확인"><br> <input
