...
<div id='overLayerBook'>
  ...
  <div class="overCont">
    <div class="smallPosterWrap">
      <img class="smallPoster" src="${pageContext.request.contextPath}/resources/img/ready.jpg">
    </div>
    ...
    <div class="overCont1">
      ...
      <div class="overContTableWrap">
        <div class="averageWrap">
          <div title="네이버/알라딘/반디앤루니스/YES24/교보문고의 평점 평균 입니다." class="avg1">
        ...
        <div class="overButtonWrap">
          <a class="overButton" id="overButtonBookLink" href="${movie.link }" target="_blank">네이버 상세</a> <a
            class="overButton" id="overButtonBookBuy" href="http://www.kyobobook.co.kr" target="_blank">사러가기</a>
        </div>
      </div>
    </div>
        ...
        <c:choose>
          ...
          <c:otherwise>
            <div class="myPointWrap">
              ...
              <div id="myPoint">
                <textarea class="pointText2" placeholder="100자 이내로 작성해 주세요."></textarea>
                <a class="pointSubmit2">완료</a>
                <div class="pointModifyWrap">
                  <a class="pointModify2">수정</a> <a class="pointDelete2">삭제</a>
                </div>
                <p class="myPostCD"></p>
              </div>
            </div>
