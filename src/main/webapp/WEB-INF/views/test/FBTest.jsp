...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/FBscript.js"></script>
...
<body>
  <div id="fb-root"></div>
  <fb:login-button max_rows="1" size="medium" show_faces="true" auto_logout_link="true"></fb:login-button>
