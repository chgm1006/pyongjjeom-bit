	...
	<div class="myPageWrap">
		...
		<dl>
			<dt class="listHead">
                			...
                			<a href="#" class="listImgLink"><img src="img/07.jpg" class="listImg"></a>
                        		<div class="detail">
                        			<table>
                                	<tr>
                                        	<td class="listTitle1" colspan="2">미녀와 야수
                                                </td>                                                
                                        </tr>
                                        <tr>
                                        	<td class="listTitle">나의 평점
                                                </td>
                                                <td  class="listDirectorValue">별표별표
                                                </td>
                                        </tr>
                                        <tr>
                                        	<td class="listTitle">한줄평
                                                </td>
                                                <td  class="listActorValue">이곳은 한줄평입니다.
                                                </td>
                                        </tr>
                                        <tr>
                                        	<td class="listTitle">나의 후기
                                                </td>
                                                <td class="listSynopValue">가까운 미래, 미믹이라 불리는 외계 종족의 침략으로 인류는 멸망 위기를 맞는다. 빌 케이지 (톰 크루즈)는 자살 작전이나 다름없는 작전에 훈련이나 장비를 제대로 갖추지 못한 상태로 배정되고 전투에 참여하자마자 죽음을 맞는다. 하지만 불가능한 일이 일어난다. 그가 다시 그 끔찍한 날이 시작된 시간에 다시 깨어나 다시 전투에 참여하게 되고 다시 죽었다가 또 다시 살아나는 것. 외계인과의 접촉으로 같은 시간대를 반복해서 겪게 되는 타임 루프에 갇히게 된 것이다.
                                                </td>
                                        </tr>
                                </table>
			...
			<dd class="listContent">
						...
						<div class="rectangle"><h3>나도 이 영화 봤다.</h3><h5>2014.06.19</h5></div>
